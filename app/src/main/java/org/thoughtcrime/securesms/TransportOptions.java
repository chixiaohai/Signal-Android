...
public class TransportOptions {
  ...
  private Optional<Optional<Integer>> defaultSubscriptionId = Optional.empty();
  ...
  public void setDefaultSubscriptionId(Optional<Optional<Integer>> subscriptionId) {
  ...
  public @NonNull TransportOption getSelectedTransport() {
    ...
    if (defaultTransportType == Type.SMS) {
      TransportOption transportOption = findEnabledSmsTransportOption(defaultSubscriptionId.orElse(systemSubscriptionId));
