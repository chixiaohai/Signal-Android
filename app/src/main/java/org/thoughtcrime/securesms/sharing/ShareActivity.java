    ...
    ContactSelectionListFragment.OnSelectionLimitReachedListener
{
  ...
  private @Nullable Bundle createExtrasFromExtraShortcutId(@NonNull String extraShortcutId) {
    ...
    Long        threadId         = null;
    int         distributionType = ThreadTable.DistributionTypes.DEFAULT;
  ...
  private void initializeResources() {
    ...
    shareConfirmClickListener = new View.OnClickListener() {
      @Override
...
//    });
  ...
  private void initializeViewModel() {
    this.viewModel = new ViewModelProvider(this, new ShareViewModel.Factory()).get(ShareViewModel.class);
  }
  ...
  private void openInterstitial(@NonNull Set<ShareContactAndThread> shareContactAndThreads, @Nullable ShareData shareData) {
    MultiShareArgs.Builder builder = new MultiShareArgs.Builder(new Set<ContactSearchKey>() {
      ...
      @NonNull @Override public Iterator<ContactSearchKey> iterator() {
        return null;
      }
      ...
      @Override public boolean add(ContactSearchKey contactSearchKey) {
        return false;
      }
      ...
      @Override public boolean addAll(@NonNull Collection<? extends ContactSearchKey> c) {
        return false;
      }
...
//                                                     MultiShareSender.getWorstTransportOption(this, multiShareArgs.getRecipientSearchKeys()),
//                                                     media,
//                                                     Stream.of(multiShareArgs.getContactSearchKeys()).map(ShareContactAndThread::getRecipientId).toList(),
...
//        startActivityForResult(intent, RESULT_MEDIA_CONFIRMATION);
  ...
  public View.OnClickListener getShareConfirmClickListener(){
